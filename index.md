...
## Introduction
In recent years, Chinese social media and e-commerce platforms such as Tiktok and Temu have gained a lot of popularity. Although the western tech companies still occupy most of the online landscape, the tide might turn. The influence of Chinese companies is gradually increasing, as stated by Enrique Dans, Tiktok and Temu ranked the first and the sixth most downloaded apps in the globe, respectively contributing to 50 million and 24 million downloads in September 2023[^2]. On the other hand, western companies like eBay failed to profit from China's users[^1]. The popularity of Chinese apps has raised a lot of concern among the public due to their policies and usages, which may compromise the cybersecurity of individuals and even national security. Misinformation on Tiktok is extremely common as deepfake and editing technologies become easily accessible, and with its 1.6 billion active users, the risk of manipulation of the public is a tangible and imminent threat[^3].



I will investigate Hong Kong, which is one of the only few Chinese territories excluded from the Great Firewall with full access to the internet. After the 2019 protests, China strengthened control over Hong Kong, which included the usage of the internet to stave off Hong Kong's civil unrest. As Hong Kong is a previous British colony, this can be a benchmark for what can happen if China uses the internet as a tool to fulfil its ambition.
...
Based on the study of Shawn Healy, the Great Firewall of China is an internet censorship system that combined the usage of both governmental and private assets. The Great Firewall uses 9 state-owned companies to manually block websites that are deemed to violate the principle of Chinese socialist morality. Various types of websites are blocked, including pornographic and websites that spread hate speech, as well as websites that mentioned about sensitive history, homosexuality and news publication[^4]. In addition, self-censorship policy is introduced to ensure private-owned websites to be accountable for violations.  
...
Furthermore, the video above created by SCMP stated that foreign websites such as Facebook and NewYork Times are blocked. Instead, alternatives are created for Chinese netizens to access and enjoy. However, even with these home-bred apps and websites there is heavy, strict surveillance and control through the implementation of the real-name system. ID number, phone number and real name are required to register any accounts for these websites. Because of that, privacy on the Chinese internet does not exist and "big brother' is always watching from behind.
